...
var tooltip = (function () {
    ...
    return {
        show: function (t) {
            oCT ||
                ((n = window.innerWidth),
                n - W > 7 && D.body.classList.add("no-scroll"),
                (oTT.innerHTML = t),
        ...
        fade: function (n) {
            var i = t,
                f;
            (i !== u && n === 1) || (i !== 0 && n === -1)
                ? ((f = r), u - i < r && n === 1 ? (f = u - i) : t < r && n === -1 && (f = i), (t = i + f * n), (oTT.style.opacity = t * 0.01))
                : (clearInterval(oTT.t), n === -1 && ((oTT.style.display = "none"), (oTT.style.visibility = "hidden"), (oTT.innerHTML = ""), (oTT.style.top = ""), (oTT.style.right = ""), D.body.classList.remove("no-scroll")));
        },
        hide: function () {
            clearInterval(oTT.t);
            oTT.t = setInterval(function () {
